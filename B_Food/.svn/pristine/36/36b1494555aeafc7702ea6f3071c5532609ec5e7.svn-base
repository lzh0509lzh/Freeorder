...
namespace B1993.DAL{
	...
	{ 
		...
		/// 增加一条数据
		/// </summary>
		public void Add(DbHelperMySQL myHelperMySQL ,B1993.Entity.log model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into log(");			
            strSql.Append("Writer,Content,CreateTime");
		...
		/// 更新一条数据
		/// </summary>
		public int Update(DbHelperMySQL myHelperMySQL ,B1993.Entity.log model, string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
        ...
        public int GetListNum(DbHelperMySQL myHelperMySQL, string strWhere, MySqlParameter[] parameters)
        {
            ...
            List<B1993.Entity.log> myList = new List<B1993.Entity.log>();
        ...
        /// </summary>
		public List<B1993.Entity.log> GetList(DbHelperMySQL myHelperMySQL ,int Top, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
			...
			strSql.Append(" a.id, a.Writer, a.Content, a.CreateTime  ");			
        ...
        /// <param name="parameters">参数(若条件中未使用参数可为null).</param>
        /// </summary>
		public List<B1993.Entity.log> GetList(DbHelperMySQL myHelperMySQL ,int Top, string filedSelect, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
