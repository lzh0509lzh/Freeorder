...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.orderlist dal = new B1993.DAL.orderlist();
        ...
        /// </summary>
        public List<B1993.Entity.orderlist> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.orderlist> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.orderlist> myList = new List<B1993.Entity.orderlist>();
        ...
        /// <summary>
        /// 获得orderlist数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新orderlist指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        ...
        /// <summary>
        /// 删除orderlist指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
