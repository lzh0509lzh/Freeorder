...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.shop_cart dal = new B1993.DAL.shop_cart();
        ...
        /// </summary>
        public List<B1993.Entity.shop_cart> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.shop_cart> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.shop_cart> myList = new List<B1993.Entity.shop_cart>();
        ...
        /// <summary>
        /// 获得shop_cart数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新shop_cart指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
