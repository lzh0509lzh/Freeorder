...
namespace B1993.WebCommon.SQLHelper
{
    /// <summary>
    /// 数据访问抽象基础类
    ...
    {
        //数据库连接字符串(web.config来配置)，可以动态更改BusinessDbConnection支持多数据库.		
        //public readonly string BusinessDbConnection = PubConstant.ConnStringCenter;
        /// <summary>
        /// 数据库连接串
        /// </summary>
        public string BusinessDbConnection { get; set; }
        ...
        {
            using (MySqlConnection connection = new MySqlConnection(BusinessDbConnection))
            {
        ...
        {
            using (MySqlConnection conn = new MySqlConnection(BusinessDbConnection))
            {
                conn.Open();
        ...
        {
            MySqlConnection connection = new MySqlConnection(BusinessDbConnection);
            MySqlCommand cmd = new MySqlCommand(strSQL, connection);
            try
            {
                connection.Open();
