...
namespace B1993.DAL{
	...
	{ 
		...
		/// 增加一条数据
		/// </summary>
		public void Add(DbHelperMySQL myHelperMySQL ,B1993.Entity.shop_cart model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into shop_cart(");			
            strSql.Append("UserId,ProductId,CartNum");
		...
		/// 更新一条数据
		/// </summary>
		public int Update(DbHelperMySQL myHelperMySQL ,B1993.Entity.shop_cart model)
		{
			StringBuilder strSql=new StringBuilder();
        ...
        public int GetListNum(DbHelperMySQL myHelperMySQL, string strWhere, MySqlParameter[] parameters)
        {
            ...
            List<B1993.Entity.shop_cart> myList = new List<B1993.Entity.shop_cart>();
        ...
        /// </summary>
		public List<B1993.Entity.shop_cart> GetList(DbHelperMySQL myHelperMySQL ,int Top, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
			...
			strSql.Append(" a.UserId, a.ProductId, a.CartNum  ");			
            ...
            using (MySqlDataReader dr = myHelperMySQL.ExecuteReader(strSql.ToString(), parameters))
            {
                while (dr.Read())
                {
                    B1993.Entity.shop_cart model = new B1993.Entity.shop_cart();
        ...
        /// <param name="parameters">参数(若条件中未使用参数可为null).</param>
        /// </summary>
		public List<B1993.Entity.shop_cart> GetList(DbHelperMySQL myHelperMySQL ,int Top, string filedSelect, string strWhere, string filedOrder, MySqlParameter[] parameters)
		{
