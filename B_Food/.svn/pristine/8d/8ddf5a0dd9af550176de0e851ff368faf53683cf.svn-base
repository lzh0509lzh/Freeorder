...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.wechatuserinfo dal = new B1993.DAL.wechatuserinfo();
		
		#region GetListCustomByXxx 方法，根据Xxx取出  信息(自定义字段)
        /// <summary>
        /// 获得wechatuserinfo数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.wechatuserinfo> GetListCustomByXxx(string Xxx)
        {
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 获得wechatuserinfo数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.wechatuserinfo> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.wechatuserinfo> myList = new List<B1993.Entity.wechatuserinfo>();
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 获得wechatuserinfo数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 更新wechatuserinfo指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 删除wechatuserinfo指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
        ...
        #region ADD
        public void ADD(B1993.Entity.wechatuserinfo model)
        {
            DbHelperMySQL myHelperMySQL = new DbHelperMySQL();
            myHelperMySQL.BusinessDbConnection = ConfigB1993.ConnStringCenter;
