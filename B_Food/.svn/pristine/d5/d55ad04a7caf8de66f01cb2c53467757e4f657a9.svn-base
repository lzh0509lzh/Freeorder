...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.product_type dal = new B1993.DAL.product_type();
        ...
        /// </summary>
        public List<B1993.Entity.product_type> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.product_type> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.product_type> myList = new List<B1993.Entity.product_type>();
