...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.orderrecord dal = new B1993.DAL.orderrecord();
        ...
        /// </summary>
        public List<B1993.Entity.orderrecord> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.orderrecord> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.orderrecord> myList = new List<B1993.Entity.orderrecord>();
