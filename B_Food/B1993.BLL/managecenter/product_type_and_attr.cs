...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.product_type_and_attr dal = new B1993.DAL.product_type_and_attr();
		
		#region GetListCustomByXxx 方法，根据Xxx取出  信息(自定义字段)
        /// <summary>
        /// 获得product_type_and_attr数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.product_type_and_attr> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <summary>
        /// 获得product_type_and_attr数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.product_type_and_attr> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.product_type_and_attr> myList = new List<B1993.Entity.product_type_and_attr>();
        ...
        /// <summary>
        /// 获得product_type_and_attr数据列表记录数(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 获得product_type_and_attr数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新product_type_and_attr指定字段(独立连接)
        /// </summary>
        ...
        /// <summary>
        /// 更新product_type_and_attr指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        ...
        /// <summary>
        /// 删除product_type_and_attr指定条件记录(独立连接)
        /// </summary>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
        ...
        /// <summary>
        /// 删除product_type_and_attr指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
