...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.log dal = new B1993.DAL.log();
        ...
        /// </summary>
        public List<B1993.Entity.log> GetListCustomByXxx(string Xxx)
        {
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 获得log数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.log> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.log> myList = new List<B1993.Entity.log>();
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 获得log数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 删除log指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
        ...
        public void Add(B1993.Entity.log model)
        {
            DbHelperMySQL myHelperMySQL = new DbHelperMySQL();
            myHelperMySQL.BusinessDbConnection = ConfigB1993.ConnStringCenter;
