...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.product_img dal = new B1993.DAL.product_img();
		
		#region GetListCustomByXxx 方法，根据Xxx取出  信息(自定义字段)
        /// <summary>
        /// 获得product_img数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.product_img> GetListCustomByXxx(string Xxx)
        {
        ...
        /// <summary>
        /// 获得product_img数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.product_img> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.product_img> myList = new List<B1993.Entity.product_img>();
        ...
        /// <summary>
        /// 获得product_img数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        ...
        /// <summary>
        /// 更新product_img指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        ...
        /// <summary>
        /// 删除product_img指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
