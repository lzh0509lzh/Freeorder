...
namespace B1993.BLL{
	...
	{	     
		private readonly B1993.DAL.userinfo dal = new B1993.DAL.userinfo();
        ...
        /// </summary>
        public List<B1993.Entity.userinfo> GetListCustomByXxx(string Xxx)
        {
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 获得userinfo数据列表，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.userinfo> GetListCustomByXxx(DbHelperMySQL myHelperMySQL, string Xxx)
        {
            List<B1993.Entity.userinfo> myList = new List<B1993.Entity.userinfo>();
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 获得userinfo数据列表记录数，(方法外传入连接对象，需要人工关闭连接)
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx"></param>
        /// </summary>
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 更新userinfo指定字段，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
...
((char)10).ToString() +
        ...
        /// <summary>
        /// 删除userinfo指定条件记录，(方法外传入连接对象，需要人工关闭连接)
        /// </summary>
        /// <param name="myHelperMySQL">自定义数据连接对象实例</param>
        /// <param name="Xxx">条件</param>
        /// <returns>生效记录数</returns>
        ...
        #region GetListNumByOpenid 方法，根据Openid取出符合条件记录数量(自定义字段)
        /// <summary>
        /// 获得userinfo数据列表记录数(独立连接)
        /// <param name="Openid"></param>
        /// </summary>
        public int GetListNumByOpenid(string Openid)
        {
            int Num = 0;
            DbHelperMySQL myHelperMySQL = new DbHelperMySQL();
            myHelperMySQL.BusinessDbConnection = ConfigB1993.ConnStringCenter;
            try
            {
                Num = this.GetListNumByOpenid(myHelperMySQL, Openid);
            }
            catch (Exception errorStr)
            {
                #region 出错打印日志
        ...
        /// <param name="Openid"></param>
        /// </summary>
        public int GetListNumByOpenid(DbHelperMySQL myHelperMySQL, string Openid)
        {
            int Num = 0;
        ...
        #region ADD
        public void ADD(B1993.Entity.userinfo model)
        {
            DbHelperMySQL myHelperMySQL = new DbHelperMySQL();
            myHelperMySQL.BusinessDbConnection = ConfigB1993.ConnStringCenter;
        ...
        #region GetListCustomByOpenid 方法，根据Openid取出  信息(自定义字段)
        /// <summary>
        /// 获得userinfo数据列表(独立连接)
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.userinfo> GetListCustomByOpenid(string Openid)
        {
            List<B1993.Entity.userinfo> myList = new List<B1993.Entity.userinfo>();
            DbHelperMySQL myHelperMySQL = new DbHelperMySQL();
            myHelperMySQL.BusinessDbConnection = ConfigB1993.ConnStringCenter;
            try
            {
                myList = this.GetListCustomByOpenid(myHelperMySQL, Openid);
            }
            catch (Exception errorStr)
            {
                #region 出错打印日志
        ...
        /// <param name="Xxx"></param>
        /// </summary>
        public List<B1993.Entity.userinfo> GetListCustomByOpenid(DbHelperMySQL myHelperMySQL, string Openid)
        {
            List<B1993.Entity.userinfo> myList = new List<B1993.Entity.userinfo>();

            //字段
            string fieldSelect = "";
            fieldSelect = "a.UserId,a.UserName,a.GroupClass,a.headimgurl";
