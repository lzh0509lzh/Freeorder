...
namespace B1993.BusinessRules
{
    ...
    {
        private const string strSqlcenter = "Database=managecenter;";
        ...
        {           
            get 
            {
                ...
                //string _connStringIp = ConfigurationManager.AppSettings["ConnStringIp"];
                //string _connStringNp = ConfigurationManager.AppSettings["ConnStringNp"];
                if (ConfigurationManager.AppSettings["ConStringEncrypt"] == "true")
                {
                    //_connectionString = DESEncrypt.Decrypt(_connStringIp) + "+" + DESEncrypt.Decrypt(_connStringNp);
                    //_connectionString += strSqlcenter;
